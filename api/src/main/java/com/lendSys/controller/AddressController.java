...
public class AddressController {
    ...
    @ApiOperation(value  = "get user address",
            tags = "get user address", notes = "get user address")
    @GetMapping(value = "/")
    ...
    @ApiOperation(value  = "add user address",
            tags = "add user address", notes = "add user address")
    ...
    @ApiOperation(value  = "edit user address",
            tags = "edit user address", notes = "edit user address")
    ...
    @ApiOperation(value  = "delete user address",
            tags = "delete user address", notes = "delete user address")
